...
## CLI (opcional)
```powershell
sla-modern-pro --url https://zabbix.exemplo/api_jsonrpc.php --user usuario ***REMOVED*** --group-id 251 --start 2026-03-01T00:00:00 --end 2026-03-31T23:59:00 --output relatorio.csv
```
